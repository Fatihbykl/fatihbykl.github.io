---
title: "Integrated CLI Terminal"
description: "Multi-tab integrated terminal with ANSI colors and automated Unity project directory sync."
slug: docs/fuzzyide/guide/terminal
---
...
- **Multi-tab Support:** You can start multiple terminal sessions simultaneously. For example, you can have a Node.js server running in one tab while performing `git` operations in another.
- **Quick Access:** You can quickly open and hide the terminal via the toolbar or shortcuts whenever you need it.
