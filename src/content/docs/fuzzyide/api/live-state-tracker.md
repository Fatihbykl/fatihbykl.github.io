---
title: "LiveStateTracker API Reference"
description: "Thread-safe runtime state tracking API reference for LiveStateTracker and TrackedVariableContext."
slug: docs/fuzzyide/api/live-state-tracker
---
