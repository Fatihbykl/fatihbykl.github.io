...
- **Save Active**: Saves all unsaved documents. You can also use `Ctrl+S` (Windows) or `Cmd+S` (Mac).
- **Refresh (Recompile)**: Instantly triggers a domain reload in Unity to compile your latest script changes without leaving the IDE window.
